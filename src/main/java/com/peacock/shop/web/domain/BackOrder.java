...
public class BackOrder {
    ...
    public BackOrder(Integer backId, String deliverySn, String orderSn, Integer orderId, String invoiceNo, Integer addTime, Byte shippingId, String shippingName, Integer userId, String actionUser, String consignee, String address, Short country, Short province, Short city, Short district, String signBuilding, String email, String zipcode, String tel, String mobile, String bestTime, String postscript, String howOos, BigDecimal insureFee, BigDecimal shippingFee, Integer updateTime, Short suppliersId, Boolean status, Integer returnTime, Short agencyId) {
        this.backId = backId;
