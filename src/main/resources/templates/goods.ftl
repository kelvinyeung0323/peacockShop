    ...
    <div class="block clearfix">
        ...
        <div class="AreaR">
            ...
            <div id="goodsInfo" class="clearfix">
                ...
                <div class="imgInfo">
                    <#if pictures??>
                    <a href="javascript:;" onclick="window.open('gallery?id=${goods.goodsId!}'); return false;"> <img src="${goods.goodsImg!}" alt="${goods.goodsName!?html}"/> </a>
                    <#else >
                ...
                <div class="textInfo">
                    <form action="javascript:addToCart(${goods.goodsId})" method="post" name="ECS_FORMBUY" id="ECS_FORMBUY" >
                        <div class="goods_style_name"> ${goods.goodsStyleName} </div>
                        <ul>
                            <!-- {if $promotion} -->
                            <li class="padd">
                            ...
                            <li class="clearfix">
                                ...
                                <dd class="ddR">
                                    ...
                                    <!-- {else} -->
                                    <strong><@spring.message "goods.goodsNumber"/></strong> {$goods.goods_number} {$goods.measure_unit}
                                    <!-- {/if} -->
                                    <!-- {/if} -->
                                </dd>
                            </li>
